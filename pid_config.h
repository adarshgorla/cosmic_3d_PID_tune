...
// =============================================================================
// MATHEMATICALLY DERIVED PID GAINS (Defined in pid_config.cpp)
// =============================================================================
...
// Channel Mapping (Defined in pid_config.cpp)
...
// Homing Standoff Setpoints (from limit switches to origin)
#define SETPOINT_HOME_A -31150
#define SETPOINT_HOME_B -31150
#define SETPOINT_HOME_C -31150
#define SETPOINT_HOME_E 100
